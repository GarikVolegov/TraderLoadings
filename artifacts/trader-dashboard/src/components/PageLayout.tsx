...
export function PageLayout({ children }: PageLayoutProps) {
  ...
  return (
    <div className="min-h-screen relative bg-background pb-20 sm:pb-24 lg:pb-8 lg:pl-48">
      ...
      {/* Main content — uniform px-4 / sm:px-6 / lg:px-8 across all pages */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-16 lg:pt-14 space-y-4 sm:space-y-6">
        {children}
      </div>
